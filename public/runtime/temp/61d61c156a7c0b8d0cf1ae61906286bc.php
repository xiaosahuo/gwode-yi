    ...
    <main id="main-container" style="min-height: 912px;">
        ...
        <div class='content'>
            <table class="table table-striped table-hover">
                ...
                <tr>
                    <td><?php if($vo['wz'] == 'sk1'): ?> 书库默认书籍-1
                        <?php elseif($vo['wz'] == 'sk2'): ?> 书库默认书籍-2
                        <?php elseif($vo['wz'] == 'sk3'): ?> 书库默认书籍-3
                        <?php elseif($vo['wz'] == 'sk4'): ?> 书库默认书籍-4
                        <?php elseif($vo['wz'] == 'sk5'): ?> 书库默认书籍-5
