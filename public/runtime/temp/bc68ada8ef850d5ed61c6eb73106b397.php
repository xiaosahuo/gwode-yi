...
<main id="main-container" style="min-height: 912px;">
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-builder table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                <form action="<?php echo url('book/sortUpdate'); ?>" id="myForm" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="idx[]" value="<?php echo $vo['idx']; ?>">
                                            <input type="hidden" name="id[]" value="<?php echo $vo['id']; ?>">
                                        </div>
                                    </td>
                                    <td>
                                        <input name="status" type="checkbox" idstatus="<?php echo $vo['id']; ?>" <?php if($vo['isvip'] == 1): ?> checked <?php endif; ?> data-size="small" onchange="modifyVip(this)">
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                </form>
    ...
    <script>
       ...
       {
           var url = "<?php echo url('Book/setVipStatus'); ?>";
