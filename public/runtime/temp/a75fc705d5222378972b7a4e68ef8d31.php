<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\notice\index.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\head.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\left.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\foot.html";i:1540978504;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
...
<main id="main-container" style="min-height: 912px;">
    ...
    <div class='content'>
        <form action="<?php echo url('Notice/index'); ?>" method="get">
            <div class="col-xs-2">
                        ...
                        <div class="table-responsive">
                            <table class="table table-builder table-hover table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $vo['delivered']; ?></td>
                                    <td><?php echo $vo['click']; ?></td>
                                    <td><?php if(empty($vo['sum_money']) || ($vo['sum_money'] instanceof \think\Collection && $vo['sum_money']->isEmpty())): ?> 0  <?php else: ?> <?php echo $vo['sum_money']; endif; ?> </td>
                                    <td><?php if($vo['book_id'] == 0): ?> 0  <?php else: ?> <?php echo $vo['count_num']; endif; ?> 次</td>
                                    <td>
                                        <?php if($vo['book_id'] == 0): else: ?>
                                        <a href="<?php echo url('Notice/details',['id' => $vo['id']]); ?>"> 查看 </a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
