<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\index\notice.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\head.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\left.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\foot.html";i:1540978504;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed ">
    ...
    <main id="main-container" style="min-height: 912px;">
        <ol class="breadcrumb">
            <a class="link-effect">推送消息管理</a>
        </ol>

        <div class='content'>

            <div class="block-content">
                <form class="form-builder row" name="form-builder" action="<?php echo url('Index/sendNotice'); ?>" method="post">
                    <div class="form-group col-md-12 " id="form_group_title">
                        <label class="col-xs-12" for="title">标题</label>

                        <div class="col-xs-5">
                            <input class="form-control" type="text" id="title" name="title" value="" placeholder="请输入标题" required="required">
                            <div class="help-block">必填</div>

                        </div>
                        <label class="col-xs-12" for="title">推送消息</label>
                        <div class="col-sm-12">
                            <input class="form-control" type="text" id="desc" name="desc" value="" placeholder="请输入消息内容" required="required">
                            <div class="help-block">必填</div>
                        </div>
                        ...
                        <div class="col-xs-5">
                            <select  class="selectpicker show-tick form-control" name='bookid'  data-live-search="true">
                                ...
                                <?php if(is_array($book) || $book instanceof \think\Collection): $i = 0; $__LIST__ = $book;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bvo): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $bvo['id']; ?>" <?php if($bvo['id'] == -1): ?> selected = "selected" <?php endif; ?>><?php echo $bvo['title']; if($bvo['id'] == -1): ?> --当前选择<?php endif; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                            <div class="help-block">&nbsp;</div>
                        </div>
                        <label class="col-xs-12" for="title">url地址</label>
                        <div class="col-sm-12">
                            <input class="form-control" type="text" id="url" name="url" value="" placeholder="请输入相关url地址" >
                            <div class="help-block">&nbsp;</div>
                        </div>
                        <label class="col-xs-12" for="title">推送渠道（勾选发送的渠道）</label>
                        <div class="col-xs-6">
                            <?php if(is_array($channel_list) || $channel_list instanceof \think\Collection): $i = 0; $__LIST__ = $channel_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cvo): $mod = ($i % 2 );++$i;?>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="channel[]" value="<?php echo $cvo['channel']; ?>" checked> <?php echo $cvo['channel']; ?>
                            </label>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                    <input type="hidden" name="token_info" value="<?php echo $token; ?>">
