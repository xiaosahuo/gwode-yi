<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/index\view\user\zj.html";i:1541229980;}*/ ?>
...
<head>
    ...
    <title>最近阅读-逐浪网</title>
    <meta name="keywords" content="逐浪">
    <meta name="description" content="最近阅读-逐浪手机小说网">
...
<div class="wrap">
    ...
    <div class="shelf-tab">
        <ul class="tab-grp-s">
            <li><a href="/index/user/shelf.html">我的书架</a></li>
            <li class="cur">最近阅读</li>
        </ul>
    </div>
    <div class="shelf-div" id="recent-div">
        <!--
        <div class="shelf-mng">
            <span class="pg">
                <strong>10</strong>/124
            </span>
            <a href="#nogo" class="mng-btn mng-start">管理</a>
            <a href="#nogo" class="mng-btn mng-done">完成</a>
        </div>
        -->
        <section class="min-list shelf-list on-mng">
            <ul id="recent-list">
                <li id="recent-513820" data-bid="513820">
                    <dl>
                        ...
                        <dd>
                            ...
                            <a href="https://m.zhulang.com/513820/316906.html" data-history="url"><p data-history="chname">更新：第四百二十七章 能活多久是多久</p>
                            </a>
                        </dd>
                    </dl>
                    <div class="opt">
                        <a class="add" href="https://m.zhulang.com/513820/316906.html" data-history="url" >继续阅读</a>
                    </div>
                </li>
            </ul>
        </section>
