<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/index\view\pay\index.html";i:1541227551;}*/ ?>
...
<div class="wrap">
    ...
    <div class="cm-box cm-mb cm-txt">
        <h4>提示</h4>
        <ol>
            <li>您所充值的逐浪币只限本站使用</li>
            <li>逐浪币可用于打赏作者、小说VIP章节订阅等，通过手机充值的逐浪奖金币不能用于打赏</li>
