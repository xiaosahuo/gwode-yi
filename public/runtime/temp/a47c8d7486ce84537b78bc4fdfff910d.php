<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\index\index.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\head.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\left.html";i:1540978504;s:85:"D:\PhpStudy\PHPTutorial\WWW\appdata\public/../application/admin\view\public\foot.html";i:1540978504;}*/ ?>
<!DOCTYPE html>
<head>
    <meta charset="utf-8">
...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed ">
    ...
    <div class='content'>
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="<?php echo url('Index/index',['type'=>1]); ?>">
                男生精选</a>
            </li>
            <li><a href="<?php echo url('Index/index',['type'=>2]); ?>">女生精选</a></li>
            <li class="dropdown">
                <a href="#" id="myTabDrop1" class="dropdown-toggle"
                   data-toggle="dropdown">本周精选<b class="caret"></b>
                </a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
                    <li><a href="<?php echo url('Index/index',['type'=>3]); ?>" tabindex="-1">
                        男</a>
                    </li>
                    <li><a href="<?php echo url('Index/index',['type'=>4]); ?>" tabindex="-1">
                        女</a>
                    </li>
                </ul>
            </li>
        ...
        <table class="table table-striped table-hover">
            <thead>
            <td class="col-xs-2">小说位置【APP首页男生精选】</td>
            <td class="col-xs-5">小说名字</td>
            <td class="col-xs-2">操作</td>
            </thead>
            <tbody>
            <!--本期精选-->
            <?php if(is_array($res) || $res instanceof \think\Collection): $k = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
            <tr>
                <td><?php echo $vo['remark']; ?> - <?php echo $k; ?>
