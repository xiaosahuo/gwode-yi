...
class Demo {
	...
	function sendAndroidBroadcast() {
		try {
			...
			$brocast->setPredefinedKeyValue("ticker",           '1');
			$brocast->setPredefinedKeyValue("title",            '1');
			$brocast->setPredefinedKeyValue("text",             '2');
...
$demo = new Demo("5b5e6c06f43e485cca0001d1", "gfu0p6sahsg9jtge6er7kko68hwlo8vn");
//$demo->sendAndroidUnicast();

$ticker=$_POST['ticker'];//'你好';//通知栏提示文字
$title = $_POST['title'];//'标题';//通知标题
$text = $_POST['text'];//'描述';
